...
### 0. Installation
Windows version of this game is in [COMP-2012H repository](https://github.com/williamlus/COMP-2012H). Download that repository and double click [start.exe](https://github.com/williamlus/COMP-2012H/blob/main/start.exe) to start the game.
